...
Последняя попытка подключения @ ',
    ...
    'LBL_GLOBAL_TEAM_DESC' => 'Видимые глобально',
    'LBL_GLOBAL_TEAM_SELECT' => 'Не найдена Глобальная группа по умолчанию. Пожалуйста, выберите группу из этого списка.',
    'LBL_GLOBAL_TEAM' => 'Восстановление доступа к глобальной группе.',
    'LBL_GO' => 'Поехали ...',
    ...
    'LBL_TO' => ' Кому ',
    'LBL_SUGARFEED_SETTINGS' => 'Настройки потока активностей',
    ...
    'LBL_OAUTH2_TOKENS_TITLE' => 'OAuth2 токены', // to be removed PR 5321
    'LBL_OAUTH2_TOKENS' => 'Просмотреть журнал сессии и разорвать активные сеансы', // to be removed PR 5321
    ...
    'LBL_GOOGLE_SUITE_ADMIN_DESC' => 'Manage your Google Suite Integration.', // PR 6527

    'LBL_JJWG_MAPS_ADMIN_CONFIG_TITLE'  => 'Настройка карт Google', // PR 6527
    ...
    'LBL_JJWG_MAPS_ADMIN_DONATE_TITLE' => 'Поддержать проект',
    'LBL_JJWG_MAPS_ADMIN_DONATE_DESC' => 'Пожалуйста, поддержите этот проект!',
    ...
    'LBL_JJWG_MAPS_ADMIN_ADDRESS_CACHE_DESC' => 'Provides access to Address Cache information. This is only cache.',  // PR 6527
    ...
    'LBL_GOOGLE_CALENDAR_SETTINGS_JSON_HELP' => 'Upload the JSON Credentials file you downloaded from Google Developers Console.', // PR 6527
    'LBL_GOOGLE_CALENDAR_GET_API_KEY' => 'Get API Credentials', // PR 6527
    ...
    'LBL_AOP_OPENING_HOURS' => 'Время открытия',
    'LBL_AOP_CLOSING_HOURS' => 'Время закрытия',
    ...
    'LBL_SIMPLE_SQL_SEARCH_ENGINE' => 'Simple SQL Search Engine',
     // Ajax Submit
    'LBL_AJAX_SUBMIT_SUCCESS' => 'The settings have been saved successfully.', // PR 6222
    'LBL_AJAX_SUBMIT_FAIL' => 'An error has occurred while saving the settings.', // PR 6222
