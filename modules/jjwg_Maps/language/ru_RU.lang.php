...
$mod_strings['LBL_CONFIG_GEOCODING_API_URL_DESC'] = 'Адрес Google Maps API V3 либо адрес прокси-сервера.'; // PR 3290
...
$mod_strings['LBL_CONFIG_GEOCODING_API_SECRET_GET_A_KEY'] = 'Получить бесплатный ключ Google Maps Geocoding API (для бесплатного геокодирования большого числа адресов в день).'; // PR 3290
