<?php /* Smarty version 2.6.31, created on 2019-03-12 23:46:17
...
<div class="buttons">
<input title="Править" accessKey="i" name="Edit" id="edit_button" value="Править" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
'; _form.action.value='EditView';_form.submit();" type="button"/>
<input id="duplicate_button" title="Дублировать" accessKey="u" class="button" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView';_form.submit();" type="button" name="Duplicate" value="Дублировать"/>
<input id="delete_button" type="button" class="button" onclick="confirmDelete();" value="Удалить" //>
<input title="Установить стандартные значения" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить все настройки данного пользователя?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Установить стандартные значения"/>
<input title="Сбросить настройки закладки " ГЛАВНАЯ class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить настройки закладки ГЛАВНАЯ?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Сбросить настройки закладки "/>
...
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">Дополнительно</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES'] == true): ?>
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">Права доступа</a>
</li>
<?php endif; ?>
</ul>
</li>
...
<a data-toggle="tab" id="tab1" href="#">Дополнительно</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES']): ?>
<li role="presentation" class="hidden-xs ">
<a data-toggle="tab" id="tab2" href="#">Права доступа</a>
</li>
<?php endif; ?>
<?php if ($this->_tpl_vars['config']['enable_action_menu']): ?>
...
<li><input title="Править" accessKey="i" name="Edit" id="edit_button" value="Править" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
'; _form.action.value='EditView';_form.submit();" type="button"/></li>
<li><input id="duplicate_button" title="Дублировать" accessKey="u" class="button" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView';_form.submit();" type="button" name="Duplicate" value="Дублировать"/></li>
<li><input id="delete_button" type="button" class="button" onclick="confirmDelete();" value="Удалить" //></li>
<li><input title="Установить стандартные значения" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить все настройки данного пользователя?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Установить стандартные значения"/></li>
<li><input title="Сбросить настройки закладки " ГЛАВНАЯ class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить настройки закладки ГЛАВНАЯ?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="Сбросить настройки закладки "/></li>
