<?php /* Smarty version 2.6.31, created on 2019-03-16 12:26:44
         compiled from cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl', 94, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl', 191, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Bugs/SearchForm_popup_query_form.tpl', 272, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='bug_number_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NUMBER','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['bug_number_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['bug_number_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['bug_number_advanced']['value']); ?>
<?php endif; ?>  
...
' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='priority_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIORITY','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'priority_advanced','name' => 'priority_advanced[]','options' => $this->_tpl_vars['fields']['priority_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['priority_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'type_advanced','name' => 'type_advanced[]','options' => $this->_tpl_vars['fields']['type_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['type_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='product_category_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRODUCT_CATEGORY','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'product_category_advanced','name' => 'product_category_advanced[]','options' => $this->_tpl_vars['fields']['product_category_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['product_category_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Bugs'), $this);?>
</label>
                            </div>
            <div class="form-item">
