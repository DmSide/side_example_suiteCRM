<?php /* Smarty version 2.6.31, created on 2019-03-12 21:56:54
	    ...
	    return {
	        ...
	        initPMG: function(){
	        	...
	        	//PackageManager.showLoginDialog();
	        	 '; ?>
<?php if ($this->_tpl_vars['module_load'] == 'true'): ?><?php echo '
	        	...
	        	'; ?>
<?php elseif ($this->_tpl_vars['IS_ALIVE'] == 'true'): ?><?php echo '
	        									_loadingBar =
					...
					_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['SEARCHING_UPDATES']; ?>
<?php echo '");
...
<?php endif; ?><?php echo '
	        ...
	        download : function(){
	        	if(confirm(\''; ?>
<?php echo $this->_tpl_vars['MOD']['DOWNLOAD_QUESTION']; ?>
<?php echo '\')){
					...
					_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['DOWNLOADING']; ?>
<?php echo '");
					_loadingBar.setBody("<img src=\\"include/javascript/yui/assets/rel_interstitial_loading.gif\\"/>");
					_loadingBar.render(document.body);
					_loadingBar.show();
	        			...
	        			_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['DL_PACKAGES_DOWNLOADING']; ?>
<?php echo ' "+_numPackagesToDownload+" '; ?>
<?php echo $this->_tpl_vars['MOD']['DL_PACKAGES_PACKAGES']; ?>
<?php echo '");
	        ...
	        PackageManager.hideWaiting();
	        	...
	        	if(typeof result != \'undefined\') {
					...
					_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['DL_PACKAGES_DOWNLOADING']; ?>
<?php echo ' "+_numDownloadsComplete+" '; ?>
<?php echo $this->_tpl_vars['MOD']['DL_PACKAGES_OF']; ?>
<?php echo ' "+_numPackagesToDownload+ " '; ?>
<?php echo $this->_tpl_vars['MOD']['DL_PACKAGES_PACKAGES']; ?>
<?php echo '");
	        		if(_numPackagesToDownload == _numDownloadsComplete){
						_loadingBar.hide();
	        			if(!'; ?>
<?php echo $this->_tpl_vars['INSTALLATION']; ?>
<?php echo '){
	        ...
	        buildListView : function(result, showDownloadButton){
		        ...
		        display += "<tr><th align=left class=\'listViewThLinkS1\'>'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_ML_NAME']; ?>
<?php echo '</th><th align=left class=\'listViewThLinkS1\'>'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_ML_TYPE']; ?>
<?php echo '</th><th align=left class=\'listViewThLinkS1\'>'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_ML_VERSION']; ?>
<?php echo '</th><th align=left class=\'listViewThLinkS1\'>'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_ML_PUBLISHED']; ?>
<?php echo '</th><th class=\'listViewThLinkS1\'>'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_ML_DESCRIPTION']; ?>
<?php echo '</th><th class=\'listViewThLinkS1\'>'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_ML_ACTION']; ?>
<?php echo '</th></tr>";
		        for (var x = 0; x < result[\'packages\'].length; x++)
	   			{
                	...
                	if((x % 2) == 0){
	   				...
	   				if(showDownloadButton){
                		install_link += "<input type=submit class=\'button\' name=\\"btn_mode\\" onclick=\\"this.form.mode.value=\'Install\';this.form.package_id.value="+result[\'packages\'][x][\'id\']+";this.form.submit();\\" value=\\"'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_BTN_DOWNLOAD']; ?>
<?php echo '\\" />";
                	}
	        				...
	        				if(typeof result != \'undefined\') {
								...
								for (var x = 0; x < result[\'updates\'].length; x++){
									...
									if(result[\'updates\'][x][\'type\'] == \'patch\'){
										tmpNodeRelease.onCheckClick = function(){this.uncheck();if(confirm(\''; ?>
<?php echo $this->_tpl_vars['MOD']['MI_REDIRECT_TO_UPGRADE_WIZARD']; ?>
<?php echo '\')){location.href = \''; ?>
<?php echo $this->_tpl_vars['UPGARDE_WIZARD_URL']; ?>
<?php echo '\'}};
									}else{
										tmpNodeRelease.onCheckClick = function(){this.data[\'isSelected\'] = this.checked;};
									}
			...
			refreshTreeRoot : function(){
				PackageManager.showWaiting();
				_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['LOADING_CATEGORIES']; ?>
<?php echo '");
 				var callback =	{
		  			success: function(data) {
						_loadingBar.hide();
			...
			refreshGrid : function(){
				PackageManager.showWaiting();
				_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['SEARCHING_PACKAGES']; ?>
<?php echo '");
 				var callback =	{
		  			success: function(data) {
		  			_loadingBar.hide();
				...
				var types = "'; ?>
<?php echo $this->_tpl_vars['GRID_TYPE']; ?>
<?php echo '";
			...
			initTabs : function(){
				...
				var detailTab = _tabs.addTab(\'details\', "'; ?>
<?php echo $this->_tpl_vars['MOD']['ML_LBL_DETAIILS']; ?>
<?php echo '");
				detailTab.setContent(\''; ?>
<?php echo $this->_tpl_vars['MOD']['ML_DESC_DOCUMENTATION']; ?>
<?php echo '\', false);
        		_tabs.addTab(\'documentation\', "'; ?>
<?php echo $this->_tpl_vars['MOD']['ML_LBL_DOCUMENTATION']; ?>
<?php echo '");
        		_tabs.addTab(\'screenshots\', "'; ?>
<?php echo $this->_tpl_vars['MOD']['ML_LBL_SCREENSHOTS']; ?>
<?php echo '");
        		_tabs.addTab(\'reviews\', "'; ?>
<?php echo $this->_tpl_vars['MOD']['ML_LBL_REVIEWS']; ?>
<?php echo '");
        		_tabs.activate(\'details\');*/
			},
			remove : function(file){
				if(confirm(\''; ?>
<?php echo $this->_tpl_vars['MOD']['REMOVE_QUESTION']; ?>
<?php echo '\')){
				//PackageManager.showWaiting();
				var callback =	{
		  			success: function(data) {
			...
			//rrs
					...
					_loadingBar.setHeader("'; ?>
<?php echo $this->_tpl_vars['MOD']['AUTHENTICATING']; ?>
<?php echo '");
					_loadingBar.setBody("<img src=\\"include/javascript/yui/assets/rel_interstitial_loading.gif\\"/>");
					_loadingBar.render(document.body);
					_loadingBar.show();
...
'; ?>
<?php echo $this->_tpl_vars['PATCHES']; ?>
<?php echo '
'; ?>
<?php echo $this->_tpl_vars['INSTALLED_MODULES']; ?>
<?php echo '
...
<?php if ($this->_tpl_vars['module_load'] == 'true'): ?><?php echo '
		...
		_fileGrid = new YAHOO.widget.ScrollingDataTable(
                ...
                [
					{key:\'name\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Name']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth*1.5), sortable: true, resizeable: true},
                    {key:\'file\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Install']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth/1.5), formatter: this.renderInstallButton, resizeable: true},
                    {key:\'unFile\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Delete']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth), formatter: this.renderDeleteButton, resizeable: true},
        		    {key:\'type\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Type']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth/1.5)},
        		    {key:\'version\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Version']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth)},
        		    {key:\'date\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Published']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth)},
        	 	    {key:\'uninstallable\',  label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Uninstallable']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth/1.5)},
        		    {key:\'description\',label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Description']; ?>
<?php echo '\', minWidth: Math.round(patch_downloads_minWidth*1.5), sortable: true}
        		],
	    ...
	    _fileGridInstalled = new YAHOO.widget.ScrollingDataTable(\'installed_grid\',
            [
			    {key:\'name\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Name']; ?>
<?php echo '\', sortable: true, \'minWidth\' : Math.round(minWidth*1.5)},
                {key:\'unFile\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Action']; ?>
<?php echo '\', formatter: this.renderUninstallButton, \'minWidth\' : Math.round(minWidth/1.5)},
                {key:\'state_file\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Enable_Or_Disable']; ?>
<?php echo '\',formatter: this.renderEnableDisableButton, \'minWidth\' : Math.round(minWidth/1.5)},
      		    {key:\'type\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Type']; ?>
<?php echo '\', \'minWidth\' : Math.round(minWidth/1.5)},
      		    {key:\'version\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Version']; ?>
<?php echo '\', \'minWidth\' : Math.round(minWidth)},
      		    {key:\'date\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Date_Installed']; ?>
<?php echo '\', \'minWidth\' : Math.round(minWidth)},
      		    {key:\'description\', label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Description']; ?>
<?php echo '\', sortable: true, \'minWidth\' : Math.round(minWidth*1.5)}
      		],
...
<?php echo '\', width: 72},
        		    {label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Build']; ?>
<?php echo '\', width: 80, sortable: true, sortType: sort.asUCString},
        		    {label: \''; ?>
<?php echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Action']; ?>
<?php echo '\', width: 90, renderer: this.renderButtons}
        		])
            );
  	    _fileGrid.autoSizeColumns = true;
	...
	'; ?>
<?php endif; ?><?php echo '
	PackageManager.showStatusMessages(\''; ?>
<?php echo $this->_tpl_vars['ML_STATUS_MESSAGE']; ?>
<?php echo '\');
}
...
PackageManagerGrid.prototype.renderModuleButtons = function(file){
	var output =  \'<table border=0 cellpadding=0 cellspacing=0><tr><td><form action="index.php?module=Administration&view=module&action=UpgradeWizard_prepare" method="post">\';
    	output += \'<input type=submit class=\\\'button\\\' name="btn_mode" onclick="this.form.mode.value=\\\'Install\\\';this.form.submit();" value="'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_BTN_INSTALL']; ?>
<?php echo '" />\';
        ...
        output += \'<input type=submit class=\\\'button\\\' name="run" value="'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_BTN_DELETE_PACKAGE']; ?>
<?php echo '" />\';
        output += \'<input type=hidden name="install_file" value="\'+file+\'" />\';
...
PackageManagerGrid.prototype.renderUninstallButton = function(elCell, oRecord, col, data) {
	...
	if(file.indexOf(\'errors_\') == 0){
		...
		var output =  \'<span style="text-align:center;"><form action="index.php?module=Administration&view=module&action=UpgradeWizard_prepare" method="post">\';
    	output += \'<input type=submit class=\\\'button\\\' name="btn_mode" onclick="this.form.mode.value=\\\'Uninstall\\\';this.form.submit();" value="'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_UNINSTALL']; ?>
<?php echo '" />\';
        output += \'<input type=hidden name="install_file" value="\'+file+\'" />\';
		output += \'<input type=hidden name="mode"/>\';
        output += \'</form></span>\';
...
PackageManagerGrid.prototype.renderEnableDisableButton = function(elCell, oRecord, col, data) {
	...
	if(state_file.indexOf(\'ENABLED_\') == 0){
		...
		output += \'<input type=submit class=\\\'button\\\' name="btn_mode" onclick="this.form.mode.value=\\\'Disable\\\';this.form.submit();" value="'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_DISABLE']; ?>
<?php echo '" />\';
		 output += \'<input type=hidden name="install_file" value="\'+file+\'" />\';
		output += \'<input type=hidden name="mode"/>\';
    	output += \'</form></span>\';
    	...
    	output += \'<input type=submit class=\\\'button\\\' name="btn_mode" onclick="this.form.mode.value=\\\'Enable\\\';this.form.submit();" value="'; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_ENABLE']; ?>
<?php echo '" />\';
    	output += \'<input type=hidden name="install_file" value="\'+file+\'" />\';
		output += \'<input type=hidden name="mode"/>\';
    	output += \'</form></span>\';
...
var output = "<span style=\'text-align:center;\'><input type=\'button\' class=\'button\' value=\''; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_UW_BTN_DELETE_PACKAGE']; ?>
<?php echo '\' onClick=\'PackageManager.remove(\\""+file+"\\");\'></span>";
...
PackageManagerGrid.prototype.renderButtons = function(packageID){
	var output = "<input type=\'button\' value=\'Download\' class=\'button\' onClick=\\"'; ?>
<?php if ($this->_tpl_vars['INSTALLATION'] != 0): ?><?php echo 'this.form.run.value=\'upload\';'; ?>
<?php endif; ?><?php echo 'this.form.release_id.value=\'"+packageID+"\';this.form.submit();\\">";
    return output;
}
